...
export const withLoading = <P extends object>(WrappedComponent: ComponentType<P & WithLoadingProps>) => {
    ...
    return (props: P) => {
        ...
        return (
            <WrappedComponent {...props} isLoading={isLoading} setLoading={setIsLoading} withLoading={withLoading} />
        );
    };
};

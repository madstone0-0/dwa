  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 mt-2">
        <button
          className="py-1 px-3 flex-1 text-sm text-black bg-yellow-400 rounded hover:bg-yellow-500"
          onClick={() => addToCart(item)}
        >
          Add to Cart
        </button>
        <button
          className="py-1 px-3 flex-1 text-sm text-white bg-wine rounded hover:bg-wine-dark"
          style={{ backgroundColor: "#722F37" }}

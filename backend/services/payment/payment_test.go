...
// 		)
//
// 		it.SetupMock(mockPool, "Exec", []any{ctx, repository.ReduceQuantityOfItem, []any{testIid, testVid, testQty}}, pgconn.CommandTag{}, nil)
//
...
// 		)
//
// 		it.SetupMock(mockPool, "Exec", []any{ctx, repository.ReduceQuantityOfItem, []any{testIid, testVid, testQty}}, pgconn.CommandTag{}, errors.New("e"))
//
// 		result := CreateTransactionRecord(ctx, mockPool, testTrans)
// 		if result.ServiceErr != nil {
// 			it.PrintError(result.ServiceErr.Err, t)
